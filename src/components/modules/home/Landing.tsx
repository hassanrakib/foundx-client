...
const Landing = () => {
  ...
  const searchTerm = useDebounce(watch("searchTerm"), 1500);
  ...
  }, [isPending, isSuccess, searchTerm, data]);
  ...
  return (
    <div className="h-[calc(100vh-64px)] bg-[url('/background.webp')] bg-cover bg-center">
